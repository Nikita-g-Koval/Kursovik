...
В таблице \ref{JSONvsXML:table} приведен пример использования пакета xltabular с автоматическим расчетом ширины столбца.
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	...
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{question:table}}
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\finishhead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	...
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{answer:table}}
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\finishhead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	...
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{test:table}}
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\finishhead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	...
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{result:table}}
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\finishhead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	...
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{diagnosis:table}}
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\finishhead
